...
const PinDescription g_APinDescription[]=
{
  ...
  // 46..61 - Extra Analog pins for J15B (PMM)
  // --------------------
  { PORTA,  6, PIO_ANALOG, PIN_ATTR_ANALOG, ADC_Channel6, NOT_ON_PWM, NOT_ON_TIMER, EXTERNAL_INT_2 }, // ADC/AIN[6]
  { PORTA,  7, PIO_ANALOG, (PIN_ATTR_PWM|PIN_ATTR_TIMER), ADC_Channel7, PWM4_CH0, TC4_CH0, EXTERNAL_INT_8 }, // ADC/AIN[7]
  { PORTB,  0, PIO_ANALOG, (PIN_ATTR_PWM|PIN_ATTR_TIMER), ADC_Channel8, PWM4_CH1, TC4_CH1, EXTERNAL_INT_9 }, // ADC/AIN[8]
  { PORTB,  1, PIO_ANALOG, 0, ADC_Channel9, NOT_ON_PWM, NOT_ON_TIMER, EXTERNAL_INT_4 }, // ADC/AIN[9]
  { PORTB,  3, PIO_ANALOG, 0, ADC_Channel11, NOT_ON_PWM, NOT_ON_TIMER, EXTERNAL_INT_5 }, // ADC/AIN[11]
  { PORTB,  4, PIO_ANALOG, 0, ADC_Channel12, NOT_ON_PWM, NOT_ON_TIMER, EXTERNAL_INT_2 }, // ADC/AIN[12]
  { PORTB,  5, PIO_ANALOG, PIN_ATTR_ANALOG, ADC_Channel13, NOT_ON_PWM, NOT_ON_TIMER, EXTERNAL_INT_2 }, // ADC/AIN[13]
  { PORTB,  6, PIO_ANALOG, (PIN_ATTR_PWM|PIN_ATTR_TIMER), ADC_Channel14, PWM4_CH0, TC4_CH0, EXTERNAL_INT_8 }, // ADC/AIN[14]
  { PORTB,  7, PIO_ANALOG, (PIN_ATTR_PWM|PIN_ATTR_TIMER), ADC_Channel15, PWM4_CH1, TC4_CH1, EXTERNAL_INT_9 }, // ADC/AIN[15]
  { PORTA,  3, PIO_ANALOG, 0, ADC_Channel1, NOT_ON_PWM, TC3_CH1, EXTERNAL_INT_NONE }, // ADC/AIN[1]
